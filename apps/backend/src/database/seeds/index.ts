...
async function seed() {
  ...
  const tenantAdmin = await userRepo.save(
    userRepo.create({
      name: "Tenant Admin",
      email: "admin@demo-travel.com",
  ...
  const customerNames = [
    ...
    {
      name: "Nita Octavia",
      email: "nita.octavia@gmail.com",
      phone: "08112345014",
    },
    {
      name: "Bagas Trianto",
      email: "bagas.trianto@gmail.com",
      phone: "08112345015",
    },
  ];
  ...
  const packagesData = [
    {
      ...
      description:
        "Jelajahi keindahan Bali dengan itinerary lengkap termasuk Tanah Lot, Ubud, dan Seminyak. Nikmati budaya lokal, kuliner khas, dan pemandangan alam yang memukau.",
      type: "tour",
      destination: "Bali",
      basePrice: 3500000,
      ...
      itinerary: [
        {
          day: 1,
          title: "Arrival & Tanah Lot",
          activities: [
            "Jemput bandara Ngurah Rai",
            "Check-in hotel Kuta",
            "Makan siang di resto lokal",
            "Sunset di Tanah Lot",
            "Makan malam di Seminyak",
          ],
        },
        {
          day: 2,
    ...
    },
    {
      ...
      description:
        "Eksplorasi keindahan Lombok dan Gili Islands yang menawan. Snorkeling di air kristal, bersantai di pantai putih, dan menikmati sunset terbaik di Indonesia.",
      type: "tour",
      destination: "Lombok",
      basePrice: 4200000,
      ...
      maxPax: 12,
      includes: [
        "Hotel bintang 3 Lombok",
        "Penginapan Gili Trawangan",
        "Fast boat Lombok-Gili",
      ...
      itinerary: [
        ...
        },
        {
          ...
          title: "Explore Gili",
          activities: [
            "Keliling pulau naik sepeda",
            "Snorkeling spot terbaik",
            "Free time di pantai",
          ],
        },
        {
          day: 4,
          title: "Kembali ke Lombok",
          activities: [
            "Fast boat balik Lombok",
            "Gunung Rinjani view point",
            "Pantai Senggigi",
          ],
        },
        {
          day: 5,
          title: "Departure",
          activities: ["Sarapan", "Check-out", "Antar bandara"],
        },
      ],
      images: [
    ...
    },
    {
      ...
      description:
        "Petualangan menyelam di surga bawah laut Raja Ampat, Papua Barat. Destinasi diving terbaik di dunia dengan keanekaragaman hayati laut yang luar biasa.",
      type: "tour",
      ...
      maxPax: 8,
      includes: [
        "Penginapan eco-lodge 6 malam",
        "Speedboat sewa private",
        "Diving 3x per hari",
        "Snorkeling equipment",
        "Makan 3x sehari",
        "Airport transfer Sorong",
      ],
      excludes: [
        "Tiket pesawat ke Sorong",
        "Equipment diving pribadi",
        "Marine park fee",
        "Pengeluaran pribadi",
      ],
      itinerary: [
        {
          ...
          activities: [
            "Jemput bandara Sorong",
            "Speedboat ke eco-lodge",
            "Orientasi diving",
          ],
        },
        {
        ...
        },
        {
          ...
          activities: ["Kayaking", "Bird watching cenderawasih", "Relaksasi"],
        },
        {
          day: 6,
          title: "Last Dive",
          activities: [
            "Dive spot terbaik pilihan",
            "Persiapan departure",
            "Farewell dinner",
          ],
        },
        {
          day: 7,
          title: "Departure",
          activities: ["Speedboat ke Sorong", "Antar ke bandara"],
        },
      ],
      images: [
    ...
    },
    {
      ...
      description:
        "Tour budaya ke Yogyakarta, kota pelajar penuh sejarah. Kunjungi Borobudur, Prambanan, Keraton, dan nikmati kuliner khas Jogja yang autentik.",
      type: "tour",
      ...
      itinerary: [
        ...
        },
        {
          ...
          activities: [
            "Sunrise Borobudur",
            "Lunch di restoran lokal",
            "Prambanan temple",
            "Sendratari Ramayana (malam)",
          ],
        },
        {
          day: 3,
    ...
    },
    {
      ...
      description:
        "Jelajahi taman nasional Komodo, bertemu komodo di habitat aslinya, snorkeling di spot terbaik, dan menikmati Pink Beach yang memesona.",
      type: "tour",
      ...
      itinerary: [
        ...
        },
        {
          ...
          title: "Rinca & Padar",
          activities: [
            "Trekking Pulau Rinca",
            "Foto iconic Padar Island",
            "Snorkeling Gili Lawa",
          ],
        },
        {
          day: 4,
          title: "Departure",
          activities: ["Sarapan", "Pasar lokal", "Antar bandara"],
        },
      ],
      images: [
    ...
    },
    {
      ...
      description:
        "Eksplorasi keindahan Danau Toba, danau vulkanik terbesar di dunia. Nikmati budaya Batak, alam pegunungan, dan ketenangan Pulau Samosir.",
      type: "tour",
      ...
      itinerary: [
        {
          ...
          title: "Medan - Parapat",
          activities: [
            "Jemput bandara Kuala Namu",
            "Perjalanan ke Parapat",
            "Makan malam ikan bakar Toba",
          ],
        },
        {
          day: 2,
        ...
        {
          day: 3,
          title: "Explore Samosir",
          activities: [
            "Keliling pulau",
            "Air Panas Pangururan",
            "Batu Gantung",
            "Sunset di tepian danau",
          ],
        },
        {
          day: 4,
          title: "Departure",
          activities: ["Sarapan", "Ferry balik", "Antar bandara Medan"],
        },
      ],
      isFeatured: false,
      isActive: true,
  ...
  for (const pkg of packagesData) {
    const saved = await packageRepo.save(
      packageRepo.create({ ...pkg, tenantId: savedTenant.id }),
    );
  ...
  const specialRequests = [
    ...
    "Vegetarian meal",
    "Honeymoon setup requested",
    "Family with toddler, butuh high chair",
    "Allergic to seafood",
    null,
    null,
    null, // most don't have special request
  ];
  ...
  for (let i = 0; i < 60; i++) {
    ...
    const travelDate = new Date(
      createdAt.getTime() + randomBetween(7, 60) * 86400000,
    );
    ...
    const booking = bookingRepo.create({
      ...
      passengerDetails,
      specialRequest:
        specialRequests[randomBetween(0, specialRequests.length - 1)],
      createdAt,
      updatedAt: createdAt,
    });
    ...
    await paymentRepo.save(
      paymentRepo.create({
        ...
        transactionId:
          statusEntry.payStatus === "paid"
            ? `TXN${Date.now()}${randomBetween(100, 999)}`
            : null,
        paidAt,
        createdAt,
        updatedAt: createdAt,
